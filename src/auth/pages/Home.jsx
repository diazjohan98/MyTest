...
function Home({ selectedProject }) {
  ...
  return (
    <div>
      {showUsers ? <Users selectedProject={selectedProject} /> : (
        <div>
          <Box
      sx={{
        paddingBottom: 5,
                    ...
                    <Grid sx={{ display: "flex", flexDirection: "row" }}>
                      ...
                      <ListItemText
                        ...
                        primary={`  ${
                          ...
                          selectedCaso.descripcion.charAt(0).toUpperCase() +
                    ...
                    <Grid sx={{ display: "flex", flexDirection: "row" }}>
                      ...
                      <ListItemText
                        ...
                        primary={`  ${
                          ...
                          selectedCaso.prioridades.charAt(0).toUpperCase() +
                    ...
                    <Grid sx={{ display: "flex", flexDirection: "row" }}>
                      ...
                      <ListItemText
                        ...
                        primary={`  ${
                          ...
                          selectedCaso.fecha_inicio.charAt(0).toUpperCase() +
                    ...
                    <Grid sx={{ display: "flex", flexDirection: "row" }}>
                      ...
                      <ListItemText
                        ...
                        primary={`  ${
                          ...
                          selectedCaso.fecha_limite.charAt(0).toUpperCase() +
